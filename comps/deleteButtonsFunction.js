export const deleteButtonsFunction = async (deleteButton) => {
    await fetch(`https://striveschool-api.herokuapp.com/api/product/${deleteButton.parentElement.attributes.id.value}`, {
          method: "DELETE",
          headers: {
